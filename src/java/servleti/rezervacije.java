...
public class rezervacije extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            while(rs.next()){
                listaRezervacija.add(new Rezervacija(rs.getInt("idRezervacije"), rs.getString("datumOdrzavanja"), rs.getString("vremeOdrzavanja"), rs.getString("tipProslave"), rs.getInt("cena"), rs.getInt("idKorisnika"), rs.getInt("idTermina")));
            }
