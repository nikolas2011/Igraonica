...
public class ukloniTermin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String upit = "DELETE FROM termin WHERE idTermina = '" + Sifra + "'";
            ...
            request.setAttribute("uspeh", "Uspesno ste uklonili termin");
            request.getRequestDispatcher("index.jsp").forward(request, response);
